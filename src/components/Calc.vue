<template>
  <div class="calculator">
    ...
    <label
      ><input type="checkbox" v-model="showvk" name="keyboard" />Отобразить
    ...
    <div v-if="showvk">
      ...
      <button @click="eraseOne" name="erase">E</button>
      <br /><br />
      <label
        ><input type="radio" value="1" id="op1" v-model="operch" />Операнд
        1</label
      >
      <label
        ><input type="radio" value="2" id="op2" v-model="operch" />Операнд
        2</label
      >
    </div>
  </div>
